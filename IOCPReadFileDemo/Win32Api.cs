    ...
    public class Win32Api
    {
       ...
       public static extern bool DeviceIoControl(
        ...
        public class UsnEntry : IComparable<UsnEntry>
        {
            ...
            public Int32 ComputedRecordLength { get; set; }
            ...
            {
                _recordLength = BitConverter.ToUInt32(recordData, 0);
                _frn = (UInt64)BitConverter.ToInt64(recordData, FR_OFFSET);
                _pfrn = (UInt64)BitConverter.ToInt64(recordData, PFR_OFFSET);
                _usn = (Int64)BitConverter.ToUInt64(recordData, USN_OFFSET);
                _reason = (UInt32)BitConverter.ToInt32(recordData, REASON_OFFSET);
...
#endif
                _name = System.Text.Encoding.Unicode.GetString(recordData, 64/*fileNameOffset*/, fileNameLength);
            ...
            {
                return string.Format("[UsnEntry: RecordLength={0}, USN={1}, FileReferenceNumber={2}, ParentFileReferenceNumber={3}, Reason={4}, Name={5}, OldName={6}, IsFolder={7}, IsFile={8}, computedLength={9}]", RecordLength, USN, (int)FileReferenceNumber, (int)ParentFileReferenceNumber, (UsnReasonCode)Reason, Name, OldName, IsFolder, IsFile, ComputedRecordLength);
            }
        }
